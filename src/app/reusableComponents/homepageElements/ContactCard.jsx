        ...
        <>
            <div className="flex items-center justify-center flex-col w-48 space-y-4 p-4 rounded-xl bg-white shadow-sm dark:bg-gradient-to-b from-[#131415] to-[#050505] border border-[#ffffff1a] hover:border-[#ffffff33]">
                ...
                <div className="flex flex-col text-center">
                    ...
                    <Link href="https://x.com/ethicoder" target="_blank" className="text-sm text-blue-600 font-bold dark:text-blue-500">
                        @ethicoder
                    </Link>
                </div>

                <Link href="https://x.com/ethicoder" target="_blank" className="px-4 py-1 text-sm whitespace-nowrap bg-gradient-to-b from-[#131415] to-[#050505] border border-[#ffffff1a] hover:border-[#ffffff33] dark:from-indigo-600 dark:to-indigo-600 dark:bg-gradient-none rounded-full text-gray-50 font-semibold"><FaXTwitter style={{ "display": "inline", "marginLeft": "2px" }} size={14} /> Follow me </Link>

            </div>

            <div className="flex items-center justify-center flex-col w-48 space-y-4 p-4 rounded-xl bg-white shadow-sm dark:bg-gradient-to-b from-[#131415] to-[#050505] border border-[#ffffff1a] hover:border-[#ffffff33]">
                <div className="flex items-center">
                    <Link href="https://t.me/madeui_code" target="_blank"> <FaTelegram size={35} />
                    </Link>
                </div>
                <div className="px-5">
                    ...
                    <div className="text-sm text-[#999] dark:text-gray-300">
                        <Link href="https://t.me/madeui_code" target="_blank">
