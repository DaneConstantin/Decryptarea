    ...
    return (
        <div className="my-40 max-w-3xl mx-auto">
            ...
            <section className='mt-8'>
                <h2 className="text-2xl  font-extrabold my-4">Welcome to MadeUI.com</h2>
                <p className='mb-4 text-lg'>These terms and conditions outline the rules and regulations for the use of  MadeUI&apos;s Website at  MadeUI.com.</p>

                <p className='mb-4 text-lg'> By accessing this website we assume you accept these terms and conditions. Do not continue to use  MadeUI.com if you do not agree to take all of the terms and conditions stated on this page.</p>
                <h2 className="text-2xl  font-extrabold my-4">Cookies</h2>
                <p className='mb-4 text-lg'>We employ the use of cookies. By accessing MadeUI.com, you agreed to use cookies in agreement with the MadeUI&apos;s Privacy Policy.</p>

                <p className='mb-4 text-lg'> By accessing this website we assume you accept these terms and conditions. Do not continue to use  MadeUI.com if you do not agree to take all of the terms and conditions stated on this page.</p>
            </section>
            <section className='mt-8'>
                <h2 className="text-2xl  font-extrabold my-4">Licensing Agreement</h2>
                <p className='mb-4 text-lg'>MadeUI grants you an ongoing, non-exclusive, right to make use of the Templates you have purchased or downloaded.</p>
            ...
            <ul className="gap-8 space-y-6 my-6 text-lg">
                <li><FaXmark style={{ display: "inline", marginRight: "8px", color: 'red' }} size={24} />You cannot create a theme or template that anyone can download for sale or for free using the Templates or derivatives of the Templates from MadeUI.com.</li>
                <li><FaXmark style={{ display: "inline", marginRight: "8px", color: 'red' }} size={24} />You cannot create a &quot;landing page&quot; or &quot;website builder&quot; app where End Users can build their own websites/landing pages using Templates or derivatives of the Templates from MadeUI.com.</li>
            </ul>
            <hr className='my-8' />

            <section>
                <h2 className="text-2xl  font-extrabold my-4">Purchases</h2>
                <p className='mb-4 text-lg'>All payments are processed securely through our Payment Gateway Provider Lemon Squeezy. MadeUI does not directly process payments through the website.</p>
                ...
                <p className='mb-4 text-lg'>MadeUI is not responsible for you not receiving your Template if you fail to provide a valid email or for technical issues outside our control.</p>
            </section>
            <hr className='my-8' />
            <section>
                <h2 className="text-2xl  font-extrabold my-4">Refunds</h2>
                <p className='mb-4 text-lg'>You have 14 days to evaluate your purchase. If your purchase fails to meet expectations, or is critically flawed in some way, contact MadeUI and we will issue a full refund pending a review.</p>

                <p className='mb-4 text-lg'>The issue of refunds is at the complete discretion of MadeUI.</p>
            </section>

            <hr className='my-8' />
            <section>
                <h2 className="text-2xl  font-extrabold my-4">Support</h2>
                <p className='mb-4 text-lg'>MadeUI provides support for any customers.</p>
                <p className='mb-4 text-lg'>Support for a purchase is governed by the usage license stated in the Terms stated above</p>
                <p className='mb-4 text-lg'>Support is valid from the date of purchase and all inquiries should be directed to <Link href="mailto:contact@madeui.com" className="text-blue-500 hover:underline">contact@madeui.com</Link></p>
            </section>
            <hr className='my-8' />
            <section>
                <h2 className="text-2xl  font-extrabold my-4">Changes</h2>
                <p className='mb-4 text-lg'>MadeUI may modify this agreement at any time. Continued use of MadeUI.com signifies acceptance of these changes.</p>
            </section>

            <p className='mb-4 text-lg'>If you have any questions, please contact us at <Link href="mailto:contact@madeui.com" className="text-blue-500 hover:underline">contact@madeui.com</Link></p>
        </div >
    );
};
